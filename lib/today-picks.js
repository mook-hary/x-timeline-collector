...
function selectTodayPicks(filteredPosts, topN, contextFn = null) {
  const { picks, debug } = selectTodayPicksDetailed(
    filteredPosts,
    topN,
    contextFn
  );
...
/**
 * Same as selectTodayPicks but returns { picks, debug } without logging.
 * Used by tests and DEBUG formatting.
 *
 * @returns {{ picks: object[], debug: object|null }}
 */
function selectTodayPicksDetailed(filteredPosts, topN, contextFn = null) {

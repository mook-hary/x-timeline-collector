...
function printHelp() {
  console.log(`x-timeline-collector AI Analyze (analyze_ai.js)

Usage:
  node analyze_ai.js [--limit N]
  node analyze_ai.js --cache-stats
  node analyze_ai.js --help
  npm run analyze:ai -- [--limit N]
...
Output:
  ...
  output/ai_progress.json
  output/ai_cache.json
...
Notes:
  Targets: analysis.confidence=low or category その他.
